...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"68bf5e26-dd7d-4612-bffd-f9a2d5b9fed0\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [32 x i8] c"com.companyname.MicroTranslator\00", align 16
...
@__DSOCacheEntry_name.1 = internal constant [27 x i8] c"libaot-Mono.Android.dll.so\00", align 16
@__DSOCacheEntry_name.2 = internal constant [38 x i8] c"libaot-System.Threading.Thread.dll.so\00", align 16
@__DSOCacheEntry_name.3 = internal constant [36 x i8] c"libaot-System.Net.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.4 = internal constant [30 x i8] c"libaot-Newtonsoft.Json.dll.so\00", align 16
@__DSOCacheEntry_name.5 = internal constant [29 x i8] c"libaot-System.Console.dll.so\00", align 16
@__DSOCacheEntry_name.6 = internal constant [54 x i8] c"libaot-System.Security.Cryptography.Algorithms.dll.so\00", align 16
@__DSOCacheEntry_name.7 = internal constant [36 x i8] c"libaot-System.ComponentModel.dll.so\00", align 16
@__DSOCacheEntry_name.8 = internal constant [46 x i8] c"libaot-System.Text.Encoding.Extensions.dll.so\00", align 16
@__DSOCacheEntry_name.9 = internal constant [43 x i8] c"libaot-System.Reflection.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.10 = internal constant [31 x i8] c"libaot-Microsoft.CSharp.dll.so\00", align 16
@__DSOCacheEntry_name.11 = internal constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 16
@__DSOCacheEntry_name.12 = internal constant [33 x i8] c"libaot-System.ObjectModel.dll.so\00", align 16
@__DSOCacheEntry_name.13 = internal constant [36 x i8] c"libaot-System.IO.Compression.dll.so\00", align 16
@__DSOCacheEntry_name.14 = internal constant [55 x i8] c"libaot-System.Private.DataContractSerialization.dll.so\00", align 16
@__DSOCacheEntry_name.15 = internal constant [36 x i8] c"libaot-Xamarin.AndroidX.Core.dll.so\00", align 16
@__DSOCacheEntry_name.16 = internal constant [43 x i8] c"libaot-System.Security.Cryptography.dll.so\00", align 16
@__DSOCacheEntry_name.17 = internal constant [27 x i8] c"libaot-Java.Interop.dll.so\00", align 16
@__DSOCacheEntry_name.18 = internal constant [38 x i8] c"libaot-System.Linq.Expressions.dll.so\00", align 16
@__DSOCacheEntry_name.19 = internal constant [33 x i8] c"libaot-System.Collections.dll.so\00", align 16
@__DSOCacheEntry_name.20 = internal constant [47 x i8] c"libaot-System.ComponentModel.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.21 = internal constant [54 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.lu.so\00", align 16
@__DSOCacheEntry_name.22 = internal constant [38 x i8] c"libaot-System.Runtime.Numerics.dll.so\00", align 16
@__DSOCacheEntry_name.23 = internal constant [45 x i8] c"libaot-System.Diagnostics.TraceSource.dll.so\00", align 16
@__DSOCacheEntry_name.24 = internal constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
@__DSOCacheEntry_name.25 = internal constant [37 x i8] c"libaot-System.Security.Claims.dll.so\00", align 16
@__DSOCacheEntry_name.26 = internal constant [50 x i8] c"libaot-System.Reflection.Emit.ILGeneration.dll.so\00", align 16
@__DSOCacheEntry_name.27 = internal constant [50 x i8] c"libSystem.Security.Cryptography.Native.Android.so\00", align 16
@__DSOCacheEntry_name.28 = internal constant [44 x i8] c"libaot-System.Collections.NonGeneric.dll.so\00", align 16
@__DSOCacheEntry_name.29 = internal constant [46 x i8] c"libMicrosoft.CognitiveServices.Speech.core.so\00", align 16
@__DSOCacheEntry_name.30 = internal constant [40 x i8] c"libaot-System.Drawing.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.31 = internal constant [50 x i8] c"libaot-System.ComponentModel.TypeConverter.dll.so\00", align 16
@__DSOCacheEntry_name.32 = internal constant [33 x i8] c"libaot-System.Data.Common.dll.so\00", align 16
@__DSOCacheEntry_name.33 = internal constant [44 x i8] c"libaot-System.Collections.Concurrent.dll.so\00", align 16
@__DSOCacheEntry_name.34 = internal constant [56 x i8] c"libaot-Microsoft.CognitiveServices.Speech.csharp.dll.so\00", align 16
@__DSOCacheEntry_name.35 = internal constant [29 x i8] c"libaot-System.Runtime.dll.so\00", align 16
@__DSOCacheEntry_name.36 = internal constant [31 x i8] c"libaot-System.Threading.dll.so\00", align 16
@__DSOCacheEntry_name.37 = internal constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 16
@__DSOCacheEntry_name.38 = internal constant [54 x i8] c"libaot-System.Runtime.Serialization.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.39 = internal constant [54 x i8] c"libaot-System.Security.Cryptography.Primitives.dll.so\00", align 16
@__DSOCacheEntry_name.40 = internal constant [21 x i8] c"libaot-System.dll.so\00", align 16
@__DSOCacheEntry_name.41 = internal constant [45 x i8] c"libaot-System.Collections.Specialized.dll.so\00", align 16
@__DSOCacheEntry_name.42 = internal constant [54 x i8] c"libaot-System.Runtime.Serialization.Formatters.dll.so\00", align 16
@__DSOCacheEntry_name.43 = internal constant [30 x i8] c"libaot-System.Xml.Linq.dll.so\00", align 16
@__DSOCacheEntry_name.44 = internal constant [61 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.audio.sys.so\00", align 16
@__DSOCacheEntry_name.45 = internal constant [60 x i8] c"libaot-System.Security.Cryptography.X509Certificates.dll.so\00", align 16
@__DSOCacheEntry_name.46 = internal constant [43 x i8] c"libaot-System.Collections.Immutable.dll.so\00", align 16
@__DSOCacheEntry_name.47 = internal constant [38 x i8] c"libaot-System.Xml.ReaderWriter.dll.so\00", align 16
@__DSOCacheEntry_name.48 = internal constant [49 x i8] c"libaot-System.Reflection.Emit.Lightweight.dll.so\00", align 16
@__DSOCacheEntry_name.49 = internal constant [51 x i8] c"libaot-Xamarin.AndroidX.VersionedParcelable.dll.so\00", align 16
@__DSOCacheEntry_name.50 = internal constant [37 x i8] c"libaot-System.Private.CoreLib.dll.so\00", align 16
@__DSOCacheEntry_name.51 = internal constant [34 x i8] c"libaot-System.Net.Requests.dll.so\00", align 16
@__DSOCacheEntry_name.52 = internal constant [41 x i8] c"libaot-System.Diagnostics.Tracing.dll.so\00", align 16
@__DSOCacheEntry_name.53 = internal constant [51 x i8] c"libaot-Microsoft.IdentityModel.Abstractions.dll.so\00", align 16
@__DSOCacheEntry_name.54 = internal constant [40 x i8] c"libaot-Microsoft.Identity.Client.dll.so\00", align 16
@__DSOCacheEntry_name.55 = internal constant [38 x i8] c"libaot-System.Private.Xml.Linq.dll.so\00", align 16
@__DSOCacheEntry_name.56 = internal constant [29 x i8] c"libaot-System.Drawing.dll.so\00", align 16
@__DSOCacheEntry_name.57 = internal constant [45 x i8] c"libaot-System.Runtime.InteropServices.dll.so\00", align 16
@__DSOCacheEntry_name.58 = internal constant [20 x i8] c"libSystem.Native.so\00", align 16
@__DSOCacheEntry_name.59 = internal constant [34 x i8] c"libaot-System.Formats.Asn1.dll.so\00", align 16
@__DSOCacheEntry_name.60 = internal constant [35 x i8] c"libaot-System.Xml.XDocument.dll.so\00", align 16
@__DSOCacheEntry_name.61 = internal constant [30 x i8] c"libaot-MicroTranslator.dll.so\00", align 16
@__DSOCacheEntry_name.62 = internal constant [35 x i8] c"libSystem.IO.Compression.Native.so\00", align 16
@__DSOCacheEntry_name.63 = internal constant [26 x i8] c"libaot-System.Linq.dll.so\00", align 16
@__DSOCacheEntry_name.64 = internal constant [16 x i8] c"libmonodroid.so\00", align 16
@__DSOCacheEntry_name.65 = internal constant [30 x i8] c"libaot-System.Net.Http.dll.so\00", align 16
@__DSOCacheEntry_name.66 = internal constant [59 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.ort.so\00", align 16
@__DSOCacheEntry_name.67 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 16
@__DSOCacheEntry_name.68 = internal constant [55 x i8] c"libMicrosoft.CognitiveServices.Speech.extension.kws.so\00", align 16
@__DSOCacheEntry_name.69 = internal constant [33 x i8] c"libaot-System.Private.Xml.dll.so\00", align 16
@__DSOCacheEntry_name.70 = internal constant [33 x i8] c"libaot-System.Private.Uri.dll.so\00", align 16
